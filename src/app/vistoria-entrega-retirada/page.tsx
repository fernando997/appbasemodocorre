...
function VistoriaEntregaContent() {
  ...
  async function finalizarVistoria() {
    ...
    try {
      ...
      const registroRes = await fetch(`${API_BASE}/base-registro-vistoria-retirar`, {
        method: 'POST',
        headers: { Authorization: `Bearer ${BUBBLE_PRIVATE_KEY}` },
        body: registroForm,
      })
      ...
      const res = await fetch(`${API_BASE}/base-vitoria-sub-retirar`, {
        method: 'POST',
        headers: {
      ...
      if (!res.ok) {
        ...
        console.error('[vistoria-entrega-retirada] erro do Bubble:', erroTexto)
