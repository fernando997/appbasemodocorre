...
A placa SEMPRE tem exatamente 7 caracteres — nunca 6, nunca 8. É MUITO comum haver duas letras IDÊNTICAS lado a lado nas 3 primeiras posições (ex: "OO", "AA", "BB") — são dois caracteres separados, cada um com seu próprio contorno completo e um pequeno espaço entre eles, não um caractere só mais largo. Antes de contar quantas letras tem no bloco de cima, procure ativamente por esse espaço/gap entre contornos — se você enxergar só 2 letras no bloco de cima, olhe de novo: quase certamente há uma terceira ali, possivelmente igual à vizinha. Nunca junte dois contornos vizinhos parecidos em um só nem pule um caractere porque "parece igual ao anterior" — conte as 7 posições visíveis na placa antes de responder.
